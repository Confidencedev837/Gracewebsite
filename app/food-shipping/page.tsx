...
export default function FoodShipping() {
    return (
        <div className="pt-32">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl">
                        <div className="flex items-center space-x-5 mb-8">
                            ...
                            <span className="text-blue-400 text-[10px] font-bold uppercase tracking-[0.3em]">Logistics Expertise</span>
                        </div>
                        <motion.h1
                            initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }}
                            className="text-5xl md:text-7xl font-bold mb-8"
                        >
                            Ship <span className="text-blue-500">Foodstuff</span> from Nigeria to UK, USA & Canada and other <span className="text-blue-500">Countries</span>.
                        </motion.h1>
