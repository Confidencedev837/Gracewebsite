        ...
        <div className="pt-32 pb-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16 flex flex-col items-center">
                    <div className="w-[1px] h-10 bg-blue-600 shadow-[0_0_15px_rgba(37,99,235,0.4)] mb-6" />
                    <span className="text-blue-400 text-[10px] font-bold uppercase tracking-[0.4em] mb-6">Reach Out</span>
